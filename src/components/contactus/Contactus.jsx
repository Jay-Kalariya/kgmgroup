            ...
            <div className="contact-form-container">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="FlexContainer">
                        ...
                        <div className="form-group">
                            <label>Email*</label>
                            <input type="text" {...register('email')} placeholder="Your email address" />
                    ...
                    <div className="FlexContainer">
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" {...register('company')} placeholder="Ex. KGM Group" />
                            <p>{errors.company?.message}</p>
                        </div>
                    </div>
                    <div className="form-group">
                        <label>Tell us about your project*</label>
                        <textarea rows={4} cols={4} {...register('project')} placeholder="Ex. Hello, KGM Group. We need help to make this project unique." />
                        <p>{errors.project?.message}</p>
                    </div>
                    <div className="ButtonSubmit">
                        <button type="submit" className="ButtonInner">Submit</button>
                    </div>
                </form>
            </div>
        </section>
